def say_with_tag(text, tag)
  say "\033[1m\033[36m" + tag.to_s.rjust(10) + "\033[0m" + "  #{text}"
end

def ask_with_tag(question, tag)
  ask "\033[0m\033[33m" + tag.to_s.rjust(10) + "\033[0m\e[32m" + "  #{question}\033[0m"
end
...
def multiple_choice(question, choices)
  ...
  answer = ask_with_tag('Enter your selection:', 'Pick up a choice') until values.keys.include?(answer)
  values[answer]
end
